 ...
 *
 * To further research individual failures, the com.ainceborn.pdfbox.util.TextStripper.file
...
public class TestTextStripper
{
    ...
    {
        File f = new File(this.getClass().getResource("/pdfbox/com/ainceborn/pdfbox/pdmodel/with_outline.pdf").toURI());
    ...
    {
        String filename = System.getProperty("com.ainceborn.pdfbox.util.TextStripper.file");
