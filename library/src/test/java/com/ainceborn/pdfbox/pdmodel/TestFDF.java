...
public class TestFDF extends TestCase
{
    ...
    {
        checkFields("/pdfbox/com/ainceborn/pdfbox/pdfparser/withcatalog.fdf");
        checkFields("/pdfbox/com/ainceborn/pdfbox/pdfparser/nocatalog.fdf");
    }
    ...
    private void checkFields(String name) throws IOException, URISyntaxException
    {
        ...
        PDDocument pdf = Loader.loadPDF(new File(TestFDF.class.getResource("/pdfbox/com/ainceborn/pdfbox/pdfparser/SimpleForm2Fields.pdf").toURI()));
