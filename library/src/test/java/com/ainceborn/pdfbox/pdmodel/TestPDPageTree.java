...
public class TestPDPageTree
{
    ...
    {
        doc = Loader.loadPDF(TestPDPageTree.class.getResourceAsStream("/pdfbox/com/ainceborn/pdfbox/pdmodel/with_outline.pdf"));
    ...
    {
        doc = Loader.loadPDF(TestPDPageTree.class.getResourceAsStream("/pdfbox/com/ainceborn/pdfbox/pdmodel/page_tree_multiple_levels.pdf"));
        for (int i = 0; i < doc.getNumberOfPages(); i++)
        {
            assertEquals(i, doc.getPages().indexOf(doc.getPage(i)));
        }
