...
import com.ainceborn.pdfbox.pdmodel.PDEmbeddedFilesNameTreeNode;
import com.ainceborn.pdfbox.pdmodel.common.filespecification.PDComplexFileSpecification;
import com.ainceborn.pdfbox.pdmodel.common.filespecification.PDEmbeddedFile;
...
public class TestEmbeddedFiles extends TestCase
{
    ...
    public void testNullEmbeddedFile() throws IOException
    {
        ...
        try
        {
            PDDocument doc = Loader.loadPDF(getClass().getResourceAsStream(
                "/pdfbox/com/ainceborn/pdfbox/pdmodel/common/null_PDComplexFileSpecification.pdf"));
    ...
    public void testOSSpecificAttachments() throws IOException
    {
        ...
        PDDocument doc = Loader.loadPDF(TestEmbeddedFiles.class.getResourceAsStream(
            "/pdfbox/com/ainceborn/pdfbox/pdmodel/common/testPDF_multiFormatEmbFiles.pdf"));
