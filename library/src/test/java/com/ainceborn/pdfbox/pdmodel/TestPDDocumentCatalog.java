...
public class TestPDDocumentCatalog
{
    ...
    public void retrievePageLabels() throws IOException
    {
        ...
        try
        {
            doc = Loader.loadPDF(TestPDDocumentCatalog.class.getResourceAsStream("/pdfbox/com/ainceborn/pdfbox/pdmodel/test_pagelabels.pdf"));
    ...
    public void retrievePageLabelsOnMalformedPdf() throws IOException
    {
        ...
        try
        {
            doc = Loader.loadPDF(TestPDDocumentCatalog.class.getResourceAsStream("/pdfbox/com/ainceborn/pdfbox/pdmodel/badpagelabels.pdf"));
            PDDocumentCatalog cat = doc.getDocumentCatalog();
    ...
    public void retrieveNumberOfPages() throws IOException
    {
        ...
        try
        {
            doc = Loader.loadPDF(TestPDDocumentCatalog.class.getResourceAsStream("/pdfbox/com/ainceborn/pdfbox/pdmodel/test.unc.pdf"));
    ...
    public void handleOutputIntents() throws IOException
    {
        ...
        try
        {
            ...
            // add an OutputIntent
            colorProfile = TestPDDocumentCatalog.class.getResourceAsStream("/pdfbox/com/ainceborn/pdfbox/pdmodel/sRGB.icc");
