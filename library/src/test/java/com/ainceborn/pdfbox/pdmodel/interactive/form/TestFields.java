...
{
    private static final String PATH_OF_PDF = "src/test/resources/pdfbox/com/ainceborn/pdfbox/pdmodel/interactive/form/AcroFormsBasicFields.pdf";
    ...
    public void testAcroFormsBasicFields() throws IOException
    {
        ...
        try
        {
            ...
            assertEquals(textField.getCOSObject().getDictionaryObject(
                ...
                "com.ainceborn.pdfbox.cos.COSStream");
