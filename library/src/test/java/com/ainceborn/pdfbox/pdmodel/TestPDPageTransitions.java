...
import com.ainceborn.pdfbox.pdmodel.interactive.pagenavigation.PDTransitionDirection;
import com.ainceborn.pdfbox.pdmodel.interactive.pagenavigation.PDTransitionStyle;
...
public class TestPDPageTransitions
{
    ...
    public void readTransitions() throws IOException, URISyntaxException
    {
        PDDocument doc = Loader.loadPDF(new File(this.getClass().getResource(
            "/pdfbox/com/ainceborn/pdfbox/pdmodel/interactive/pagenavigation/transitions_test.pdf").toURI()));
