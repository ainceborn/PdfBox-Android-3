...
public class CCITTFactoryTest extends TestCase
{
    ...
    {
        String tiffPath = "pdfbox/com/ainceborn/pdfbox/pdmodel/graphics/image/ccittg4multi.tif";
...
//        imageReader.dispose();
    ...
    {
        String tiffG4Path = "pdfbox/com/ainceborn/pdfbox/pdmodel/graphics/image/ccittg4.tif";
...
//        checkIdent(bim, ximage3.getOpaqueImage()); TODO: PdfBox-Android
    ...
    public void testCreateFromFileLock() throws IOException
    {
        ...
        String tiffG3Path = "pdfbox/com/ainceborn/pdfbox/pdmodel/graphics/image/ccittg3.tif";
    ...
    {
        PDDocument document = new PDDocument();
        String basePath = "pdfbox/com/ainceborn/pdfbox/pdmodel/graphics/image/ccittg3-garbage-padded-fields";
