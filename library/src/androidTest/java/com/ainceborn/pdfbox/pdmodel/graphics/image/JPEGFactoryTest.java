...
import com.ainceborn.pdfbox.android.TestResourceGenerator;
...
import static com.ainceborn.pdfbox.pdmodel.graphics.image.ValidateXImage.colorCount;
import static com.ainceborn.pdfbox.pdmodel.graphics.image.ValidateXImage.doWritePDF;
import static com.ainceborn.pdfbox.pdmodel.graphics.image.ValidateXImage.validate;
...
public class JPEGFactoryTest
{
    ...
    public void testCreateFromStream() throws IOException
    {
        ...
        InputStream stream = testContext.getAssets().open(
            "pdfbox/com/ainceborn/pdfbox/pdmodel/graphics/image/jpeg.jpg");
    ...
    {
        PDDocument document = new PDDocument();
        InputStream stream = testContext.getAssets().open("pdfbox/com/ainceborn/pdfbox/pdmodel/graphics/image/jpegcmyk.jpg");
        PDImageXObject ximage = JPEGFactory.createFromStream(document, stream);
        validate(ximage, 8, 343, 287, "jpg", PDDeviceRGB.INSTANCE.getName());

        doWritePDF(document, ximage, testResultsDir, "jpegcmykstream.pdf");
        checkJpegStream(testResultsDir, "jpegcmykstream.pdf", testContext.getAssets().open("pdfbox/com/ainceborn/pdfbox/pdmodel/graphics/image/jpegcmyk.jpg"));
    }
    ...
    public void testCreateFromStream256() throws IOException
    {
        PDDocument document = new PDDocument();
        InputStream stream = testContext.getAssets().open(
            "pdfbox/com/ainceborn/pdfbox/pdmodel/graphics/image/jpeg256.jpg");
        PDImageXObject ximage = JPEGFactory.createFromStream(document, stream);
