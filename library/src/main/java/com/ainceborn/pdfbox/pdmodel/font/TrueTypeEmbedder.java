...
import com.ainceborn.fontbox.ttf.HeaderTable;
import com.ainceborn.fontbox.ttf.HorizontalHeaderTable;
...
import com.ainceborn.fontbox.ttf.TTFSubsetter;
...
abstract class TrueTypeEmbedder implements Subsetter
{
    ...
    {
        // PDFBOX-6193: hash might be negative due to an overflow if the map contains lots of values
