 ...
 */
package com.ainceborn.pdfbox.pdmodel.fdf;
...
import com.ainceborn.pdfbox.pdmodel.interactive.action.PDAdditionalActions;
    ...
    public FDFField(Element fieldXML) throws IOException
    {
        ...
        for (int i = 0; i < nodeList.getLength(); i++)
        {
            ...
            if (node instanceof Element)
            {
                ...
                {
                    setValue(com.ainceborn.pdfbox.util.XMLUtil.getNodeValue(child));
                }
                else if (child.getTagName().equals("value-richtext"))
                {
                    setRichText(new COSString(com.ainceborn.pdfbox.util.XMLUtil.getNodeValue(child)));
                }
