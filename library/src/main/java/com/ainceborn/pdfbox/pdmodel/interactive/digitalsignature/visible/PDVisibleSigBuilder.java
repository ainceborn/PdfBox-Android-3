 ...
 */
package com.ainceborn.pdfbox.pdmodel.interactive.digitalsignature.visible;
...
public class PDVisibleSigBuilder implements PDFTemplateBuilder
{
     ...
     * {@inheritDoc }
     *
     * @deprecated use {@link #createAffineTransform(com.ainceborn.harmony.awt.geom.AffineTransform) }
     */
    @Override
    @Deprecated
