 ...
 */
package com.ainceborn.pdfbox.pdmodel.font.encoding;

import java.util.Map;

import com.ainceborn.fontbox.afm.CharMetric;
...
public class Type1Encoding extends Encoding
{
     ...
     */
    public static Type1Encoding fromFontBox(com.ainceborn.fontbox.encoding.Encoding encoding)
    {
