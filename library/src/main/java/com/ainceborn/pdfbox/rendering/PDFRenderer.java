...
public class PDFRenderer
{
     ...
     * <p>
     * Read {@link #renderPageToGraphics(int, Paint, Canvas, float, float, com.ainceborn.pdfbox.rendering.RenderDestination) renderPageToGraphics(int, Graphics2D, float, float, RenderDestination)}
     * before using this.
     *
     * @param pageIndex the zero-based index of the page to be converted
