...
import com.ainceborn.pdfbox.util.CleanerCompat;
...
public final class COSName extends COSBase implements Comparable<COSName>
{
    ...
    private static final CleanerCompat.CleanerWrapper CLEANER = CleanerCompat.create();
    ...
    public int compareTo(COSName other)
    {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            ...
            return IOUtils.compare(nameBytes, other.nameBytes);
        }
    }
